...
\title{Modeling Efficiency of Self-Administered Pension Funds in Zimbabwe}
\subtitle{A Frontier-Based Optimization Analysis and Random Forest Model}
\author{H220021Y}
...
\begin{frame}
    ...
    \begin{itemize}
        \item Pension funds are major long-term institutional investors, mobilising savings and allocating capital in support of retirement income security
        \item Their operational effectiveness is critical for trust, fund sustainability, and timely access to benefits (Barr \& Diamond, 2016)
        \item Frontier-based efficiency measurement has gained prominence over traditional performance indicators
        \item DEA, introduced by Charnes, Cooper \& Rhodes (1978), is the predominant non-parametric tool for evaluating relative efficiency
        \item Zimbabwe's pension sector faces unique challenges:
        \begin{itemize}
            \item Hyperinflationary crisis of 2007--2008 wiped out accumulated savings
            \item Currency volatility, illiquid capital markets, constrained investment opportunities (IPEC, 2023)
        \end{itemize}
    \end{itemize}
\end{frame}
